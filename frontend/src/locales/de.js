...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Halal Pro Gym locally on this device.": 'Dieser Browser unterstützt keine Passkeys — du kannst Halal Pro Gym trotzdem lokal auf diesem Gerät nutzen.',
  ...
  'Rest-timer alerts, even if Halal Pro Gym is closed.': 'Pausen-Timer-Alarm, auch wenn Halal Pro Gym geschlossen ist.',
  ...
  'Synced with your Halal Pro Gym server.': 'Mit deinem Halal Pro Gym-Server synchronisiert.',
  'Disconnect': 'Trennen',
  ...
  'Sync this device to your own self-hosted Halal Pro Gym instead.': 'Dieses Gerät stattdessen mit deinem eigenen self-hosted Halal Pro Gym synchronisieren.',
  'Pair the mobile app': 'Mobile App koppeln',
  'Connect the Halal Pro Gym app on your phone to this account.': 'Verbinde die Halal Pro Gym-App auf deinem Handy mit diesem Konto.',
  'Could not generate a code': 'Code konnte nicht erstellt werden',
  'On the Halal Pro Gym app, choose “Connect to my server”, then enter this address and the code below. It expires in 5 minutes.': 'Wähle in der Halal Pro Gym-App „Mit meinem Server verbinden“, gib dann diese Adresse und den Code unten ein. Er läuft in 5 Minuten ab.',
  'Enter your server address and the code': 'Serveradresse und Code eingeben',
  'Connected': 'Verbunden',
  'Could not connect': 'Verbindung fehlgeschlagen',
  'Open Settings → “Pair the mobile app” on the Halal Pro Gym site you’re already signed into, then enter its address and the code shown there.': 'Öffne auf der Halal Pro Gym-Seite, bei der du bereits angemeldet bist, Einstellungen → „Mobile App koppeln“, und gib dann deren Adresse und den dort angezeigten Code ein.',
  'Server address (e.g. gym.example.com)': 'Serveradresse (z. B. gym.example.com)',
  'Pairing code': 'Kopplungscode',
  'Connecting…': 'Verbinde …',
  'Connect': 'Verbinden',
  'How do you want to use Halal Pro Gym?': 'Wie möchtest du Halal Pro Gym nutzen?',
  'Use on this device': 'Auf diesem Gerät nutzen',
  'Local keeps everything on this phone. Connecting syncs to your own Halal Pro Gym server instead — you can switch later in Settings.': 'Lokal behält alles auf diesem Handy. Verbinden synchronisiert stattdessen mit deinem eigenen Halal Pro Gym-Server — du kannst das später in den Einstellungen ändern.',
