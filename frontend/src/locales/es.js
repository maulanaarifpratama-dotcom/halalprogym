...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Halal Pro Gym locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar Halal Pro Gym localmente en este dispositivo.',
  ...
  'Rest-timer alerts, even if Halal Pro Gym is closed.': 'Avisos del temporizador de descanso, incluso con Halal Pro Gym cerrado.',
  ...
  'Synced with your Halal Pro Gym server.': 'Sincronizado con tu servidor de Halal Pro Gym.',
  ...
  'Sync this device to your own self-hosted Halal Pro Gym instead.': 'Sincroniza este dispositivo con tu propio Halal Pro Gym self-hosted.',
  'Pair the mobile app': 'Emparejar la app móvil',
  'Connect the Halal Pro Gym app on your phone to this account.': 'Conecta la app de Halal Pro Gym en tu móvil a esta cuenta.',
  'Could not generate a code': 'No se pudo generar un código',
  'On the Halal Pro Gym app, choose “Connect to my server”, then enter this address and the code below. It expires in 5 minutes.': 'En la app de Halal Pro Gym, elige «Conectar a mi servidor», luego introduce esta dirección y el código de abajo. Caduca en 5 minutos.',
  ...
  'Open Settings → “Pair the mobile app” on the Halal Pro Gym site you’re already signed into, then enter its address and the code shown there.': 'En Ajustes → «Emparejar la app móvil» del sitio de Halal Pro Gym en el que ya has iniciado sesión, luego introduce su dirección y el código que aparece ahí.',
  'Server address (e.g. gym.example.com)': 'Dirección del servidor (p. ej. gym.example.com)',
  'Pairing code': 'Código de emparejamiento',
  'Connecting…': 'Conectando…',
  'Connect': 'Conectar',
  'How do you want to use Halal Pro Gym?': '¿Cómo quieres usar Halal Pro Gym?',
  'Use on this device': 'Usar en este dispositivo',
  'Local keeps everything on this phone. Connecting syncs to your own Halal Pro Gym server instead — you can switch later in Settings.': 'Local mantiene todo en este teléfono. Conectar sincroniza con tu propio servidor de Halal Pro Gym — puedes cambiarlo luego en Ajustes.',
