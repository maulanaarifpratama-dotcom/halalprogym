...
export const PT_BR_OVERRIDES = {
  ...
  'Describe it again': 'Descreva de novo',
  'Describe it the way you would say it out loud, including how much.': 'Descreva como você falaria em voz alta, incluindo a quantidade.',
  'Describe what you ate first.': 'Primeiro descreva o que você comeu.',
  'Editing on — your numbers win.': 'Edição ativada — seus números valem.',
  'Endpoint (optional) — default api.openai.com': 'Endpoint (opcional) — padrão api.openai.com',
  'Estimating…': 'Estimando…',
  'Get a free key': 'Pegar uma chave gratuita',
  'If you log this': 'Se você registrar isso',
  ...
  'Paste your API key first.': 'Cole sua chave de API primeiro.',
  'Requests go straight from this device to {0} with your key. Your quota, your bill — and we never see either.': 'As requisições vão direto deste aparelho para {0} com sua chave. Sua cota, sua conta — e nunca vemos nenhuma das duas.',
  'Save and log it': 'Salvar e registrar',
  'Save to my foods only': 'Só salvar nos meus alimentos',
  'Saved to your foods': 'Salvo nos seus alimentos',
  'Sent to your own provider with your own key. We never see it.': 'Enviado ao seu próprio provedor com sua própria chave. Nunca vemos isso.',
  'Set it up in Settings': 'Configurar em Ajustes',
  'Some numbers were out of physical range and were capped.': 'Alguns números estavam fora do que é fisicamente possível e foram limitados.',
  'That did not work. You can still add the food by hand.': 'Não deu certo. Você ainda pode adicionar o alimento na mão.',
  'The answer could not be read. Try describing the food differently.': 'Não foi possível ler a resposta. Tente descrever o alimento de outro jeito.',
  'The calories and the macros disagree — check them before saving.': 'As calorias e os macros não batem — confira antes de salvar.',
  'The key is stored on this device only, unencrypted, and is never synced or sent to us. Anyone with access to this browser profile can read it.': 'A chave fica só neste aparelho, sem criptografia, e nunca é sincronizada nem enviada para nós. Qualquer pessoa com acesso a este perfil do navegador consegue ler.',
  'The provider rejected that API key. Check it in Settings.': 'O provedor recusou essa chave de API. Confira em Ajustes.',
  'The provider took too long. Try again, or enter the numbers by hand.': 'O provedor demorou demais. Tente de novo, ou digite os números na mão.',
  'This browser will not let the app store anything.': 'Este navegador não deixa o app guardar nada.',
  'This uses your own API key, so the request goes straight from this device to the provider — never through us. A free key from Google AI Studio is enough.': 'Isso usa sua própria chave de API, então a requisição vai direto deste aparelho para o provedor — nunca passa por nós. Uma chave gratuita do Google AI Studio já basta.',
  'What did you eat?': 'O que você comeu?',
  'Your provider says you are out of quota for now.': 'Seu provedor diz que sua cota acabou por enquanto.',
  ...
  // Portugal escreve 'Ainda sem exercícios.'; o Brasil usa a forma com 'não há', igual à linha
  // acima. Override, e não herança, porque a diferença é regional de facto.
  ...
  'Signs this profile out on every device, including this one. You can sign in again anytime.':
    'Encerra a sessão deste perfil em todos os dispositivos, inclusive neste. Você pode entrar novamente quando quiser.',
  'Sign out everywhere': 'Sair de todos os dispositivos',
  ...
  'A small file a friend imports into their own Halal Pro Gym — routines only, none of your workouts or weigh-ins.': 'Um pequeno arquivo que um amigo pode importar no próprio Halal Pro Gym — somente rotinas, sem seus treinos ou pesagens.',
  ...
  'Replaces your current Sunday–Saturday assignments.': 'Substitui os dias definidos de domingo a sábado.',
  'Added {0} routines to your plan': '{0} rotinas adicionadas ao seu plano',
  'this isn’t a Halal Pro Gym plan file': 'este não é um arquivo de plano do Halal Pro Gym',
  ...
  'to install Halal Pro Gym as a full-screen app.': 'para instalar o Halal Pro Gym como aplicativo em tela cheia.',
  ...
  /* --- auth Supabase + notifikasi: yang berbeda regional dari pt-PT --- */
  'A sign-in link is on its way to {0}. Open it on this device — the link signs you in here.':
    'Um link de acesso está a caminho de {0}. Abra no seu dispositivo — o link faz login aqui.',
  'Blocked in your browser settings.': 'Bloqueado nas configurações do seu navegador.',
  'Check your email': 'Veja seu e-mail',
  'Deletes your plan, workouts and body weight — on this device and in your account. This cannot be undone.':
    'Apaga seu plano, treinos e peso corporal — neste dispositivo e na sua conta. Não dá para desfazer.',
  'Enter a valid email address': 'Digite um e-mail válido',
  'No password. We send a link — opening it signs you in.':
    'Sem senha. Enviamos um link — abrir já faz login.',
  'Sending…': 'Enviando…',
  'Sign in with email': 'Entrar com e-mail',
  'Signing in only syncs your data — your workouts stay yours.':
    'Entrar só sincroniza seus dados — seus treinos continuam seus.',
  'Syncs your plan and history across your devices.':
    'Sincroniza seu plano e histórico entre seus dispositivos.',
