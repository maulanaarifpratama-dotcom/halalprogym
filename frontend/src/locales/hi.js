...
export default {
  ...
  'Signs this profile out on every device, including this one. You can sign in again anytime.':
    'इस प्रोफ़ाइल को हर डिवाइस पर, इसे भी मिलाकर, साइन-आउट करता है। आप जब चाहें प्र साइन-इन कर सकते हैं।',
  'Sign out everywhere': 'हर जगह साइन आउट करें',
  ...
  'to install Halal Pro Gym as a full-screen app.': 'से Halal Pro Gym को फुल-स्क्रीन ऐप के रूप में इंस्टॉल करें।',
  ...
  'back': 'पीठ', 'cardio': 'कार्डियो', 'chest': 'छाती', 'full body': 'पूरा शरीर', 'lower arms': 'अग्रबाहु',
  ...
  'name + body part, no demo photo': 'नाम + बॉडी पार्ट, बिना डेमो फ़ोटो',
  ...
  'A small file a friend imports into their own Halal Pro Gym — routines only, none of your workouts or weigh-ins.': 'एक छोटी फ़ाइल जिसे कोई दोस्त अपने Halal Pro Gym में आयात कर सके — सिर्फ़ रूटीन, आपके वर्कआउट या वज़न नहीं।',
  ...
  'Replaces your current Sunday–Saturday assignments.': 'आपके मौजूदा रवि–शनि निर्धारण को बदल देता है।',
  'Added {0} routines to your plan': 'आपके प्लान में {0} रूटीन जोड़े गए',
  'this isn’t a Halal Pro Gym plan file': 'यह Halal Pro Gym प्लान फ़ाइल नहीं है',
  'Shared routine': 'साझा किया गया रूटीन',
  'Unknown exercise': 'अज्ञात व्यायाम',
  'Weekly Training Plan': 'साप्ताहिक ट्रेनिंग प्लान',
  'Made with Halal Pro Gym': 'Halal Pro Gym से बनाया गया',
  ...
  'Reload Halal Pro Gym': 'Halal Pro Gym फिर से लोड करें',
  ...
  '{0} equipment type': '{0} प्रकार के उपकरण',
  ...
  'A sign-in link is on its way to {0}. Open it on this device — the link signs you in here.':
    '{0} पर साइन-इन लिंक भेजा जा रहा है। इसी डिवाइस पर खोलें — लिंक यहीं साइन-इन कर देगा।',
  'All data stays on this device': 'सारा डेटा इसी डिवाइस पर रहता है',
  'Blocked in your browser settings.': 'आपके ब्राउज़र सेटिंग्स में ब्लॉक है।',
  'Check your email': 'अपना ईमेल देखें',
  'Continue with Google': 'Google से जारी रखें',
  'Could not send the link': 'लिंक भेजा नहीं जा सका',
  'Deletes your plan, workouts and body weight — on this device and in your account. This cannot be undone.':
    'आपका प्लान, वर्कआउट और वजन मिटा देता है — इस डिवाइस पर और खाते में भी। यह वापस नहीं होगा।',
  'Demo': 'डेमो',
  ...
  'No account sync is set up in this build — everything stays on this device.':
    'इस बिल्ड में खाता सिंक सेट नहीं है — सब कुग इसी डिवाइस पर रहता है।',
  'No password. We send a link — opening it signs you in.':
    'कोई पासवर्ड नहीं। हम लिंक भेजते हैं — खोलने पर साइन-इन हो जाता है।',
  'Off — a beep still plays while the app is open.': 'बंद — ऐप खुला हो तो बीप बजती रहती है।',
  'On — shown when a rest finishes.': 'चालू — रेस्ट खत्म होने पर दिखता है।',
  'Reset': 'रीसेट',
  'Rest timer alert': 'रेस्ट टाइमर अलर्ट',
  'Send the link': 'लिंक भेजें',
  'Sending…': 'भेज रहे हैं…',
  'Sign in with email': 'ईमेल से साइन-इन',
  'Signing in only syncs your data — your workouts stay yours.':
    'साइन-इन सिर्य डेटा सिंक करता है — आपके वर्कआउट आपके ही रहते हैं।',
  'Source code': 'सोर्स कोड',
  'Syncs your plan and history across your devices.':
    'आपके डिवाइसों के बीच प्लान और हिस्ट्री सिंक करता है।',
  ...
  'A free key from Google AI Studio is enough for everyday use.': 'रोज़ के इस्तेमाल के लिए Google AI Studio की मुफ़्त कुंजी काफ़ी है।',
  'AI': 'एआई',
  'AI estimates': 'एआई अनुमान',
  'API key': 'एपीआई कुंजी',
  'Add your own API key in Settings first.': 'पहले सेटिंग्स में अपनी एपीआई कुंजी जोड़ें।',
  'Check before saving': 'सहेजने से पहले जाँच लें',
  'Describe it again': 'फिर से बताएँ',
  'Describe it the way you would say it out loud, including how much.': 'जैसे बोलकर बताते हैं वैसे ही लिखें — मात्रा भी।',
  'Describe what you ate first.': 'पहले बताएँ आपने क्या खाया।',
  'Editing on — your numbers win.': 'संपादन चालू — आपके अंक ही मान्य हैं।',
  'Endpoint (optional) — default api.openai.com': 'एंडपॉइंट (वैकल्पिक) — डिफ़ॉल्ट api.openai.com',
  'Estimate with AI': 'एआई से अनुमान लगाएँ',
  'Estimating…': 'अनुमान लगाया जा रहा है…',
  'Get a free key': 'मुफ़्त कुंजी लें',
  'Grams per serving': 'प्रति सर्विंग ग्राम',
  'If you log this': 'अगर यह दर्ज करें',
  ...
  'Nutrition estimates': 'पोषण अनुमान',
  'Nutrition per serving': 'प्रति सर्विंग पोषण',
  'Optional. With your own API key, the app can estimate calories and macros from a description like "nasi uduk satu porsi" — which is exactly what no free, commercially usable Indonesian food database gives us.': 'वैकल्पिक। अपनी एपीआई कुंजी के साथ ऐप "nasi uduk satu porsi" जैसे विवरण से कैलोरी और मैक्रो का अनुमान लगा सकता है — और यही वह चीज़ है जो कोई भी मुफ़्त, व्यावसायिक रूप से उपयोग योग्य इंडोनेशियाई खाद्य डेटाबेस नहीं देता।',
  'Paste your API key first.': 'पहले अपनी एपीआई कुंजी चिपकाएँ।',
  'Requests go straight from this device to {0} with your key. Your quota, your bill — and we never see either.': 'अनुरोध आपकी कुंजी के साथ इसी डिवाइस से सीधे {0} जाते हैं। आपका कोटा, आपका बिल — और हम दोनों में से कुछ नहीं देखते।',
  'Save and log it': 'सहेजें और दर्ज करें',
  'Save to my foods only': 'सिर्फ़ मेरे खानों में सहेजें',
  'Saved to your foods': 'आपके खानों में सहेजा गया',
  'Sent to your own provider with your own key. We never see it.': 'आपकी कुंजी से आपके ही प्रदाता को भेजा जाता है। हम इसे कभी नहीं देखते।',
  'Set it up in Settings': 'सेटिंग्स में सेट करें',
  'Some numbers were out of physical range and were capped.': 'कुछ अंक भौतिक रूप से संभव सीमा से बाहर थे, इसलिए सीमित कर दिए गए।',
  'That did not work. You can still add the food by hand.': 'यह नहीं चला। खाना अब भी हाथ से जोड़ सकते हैं।',
  'The answer could not be read. Try describing the food differently.': 'उत्तर पढ़ा नहीं जा सका। खाने को दूसरे तरीके से बताकर देखें।',
  'The calories and the macros disagree — check them before saving.': 'कैलोरी और मैक्रो मेल नहीं खाते — सहेजने से पहले जाँच लें।',
  'The key is stored on this device only, unencrypted, and is never synced or sent to us. Anyone with access to this browser profile can read it.': 'कुंजी सिर्फ़ इस डिवाइस पर, बिना एन्क्रिप्शन रखी जाती है, और कभी सिंक या हमें नहीं भेजी जाती। इस ब्राउज़र प्रोफ़ाइल तक पहुँच रखने वाला कोई भी इसे पढ़ सकता है।',
  'The provider rejected that API key. Check it in Settings.': 'प्रदाता ने वह एपीआई कुंजी अस्वीकार कर दी। सेटिंग्स में जाँचें।',
  'The provider took too long. Try again, or enter the numbers by hand.': 'प्रदाता ने बहुत समय लिया। दोबारा कोशिश करें, या अंक हाथ से भरें।',
  'These numbers are an estimate, not a measurement.': 'ये अंक अनुमान हैं, माप नहीं।',
  'This browser will not let the app store anything.': 'यह ब्राउज़र ऐप को कुछ भी सहेजने नहीं देता।',
