...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Halal Pro Gym locally on this device.": 'यह ब्राउज़र पासकी सपोर्ट नहीं करता — फिर भी आप इस डिवाइस पर Halal Pro Gym लोकली इस्तेमाल कर सकते हैं।',
  ...
  'Rest-timer alerts, even if Halal Pro Gym is closed.': 'आराम टाइमर अलर्ट, Halal Pro Gym बंद होने पर भी।',
  ...
  'Synced with your Halal Pro Gym server.': 'आपके Halal Pro Gym सर्वर के साथ सिंक हो गया।',
  ...
  'Sync this device to your own self-hosted Halal Pro Gym instead.': 'इसके बजाय इस डिवाइस को अपने खुद के सेल्फ़-होस्टेड Halal Pro Gym से सिंक करें।',
  'Pair the mobile app': 'मोबाइल ऐप पेयर करें',
  'Connect the Halal Pro Gym app on your phone to this account.': 'अपने फ़ोन पर Halal Pro Gym ऐप को इस अकाउंट से जोड़ें।',
  'Could not generate a code': 'कोड जनरेट नहीं हो सका',
  'On the Halal Pro Gym app, choose “Connect to my server”, then enter this address and the code below. It expires in 5 minutes.': 'Halal Pro Gym ऐप में "मेरे सर्वर से कनेक्ट करें" चुनें, फिर यह पता और नीचे दिया कोड डालें। यह 5 मिनट में समाप्त हो जाता है।',
  ...
  'Open Settings → “Pair the mobile app” on the Halal Pro Gym site you’re already signed into, then enter its address and the code shown there.': 'जिस Halal Pro Gym साइट में आप पहले से साइन इन हैं, वहाँ सेटिंग्स → "मोबाइल ऐप पेयर करें" खोलें, फिर उसका पता और वहाँ दिखा कोड डालें।',
  'Server address (e.g. gym.example.com)': 'सर्वर का पता (जैसे gym.example.com)',
  'Pairing code': 'पेयरिंग कोड',
  'Connecting…': 'कनेक्ट हो रहा है…',
  'Connect': 'कनेक्ट करें',
  'How do you want to use Halal Pro Gym?': 'आप Halal Pro Gym का उपयोग कैसे करना चाहते हैं?',
  'Use on this device': 'इस डिवाइस पर उपयोग करें',
  'Local keeps everything on this phone. Connecting syncs to your own Halal Pro Gym server instead — you can switch later in Settings.': 'लोकल सब कुछ इसी फ़ोन पर रखता है। कनेक्ट करने पर इसके बजाय आपके अपने Halal Pro Gym सर्वर से सिंक होता है — इसे बाद में सेटिंग्स में बदला जा सकता है।',
