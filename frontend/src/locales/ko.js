...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Halal Pro Gym locally on this device.": '이 브라우저는 패스키를 지원하지 않아요 — 그래도 이 기기에서 Halal Pro Gym을 로컬로 사용할 수 있습니다.',
  ...
  'Rest-timer alerts, even if Halal Pro Gym is closed.': 'Halal Pro Gym이 닫혀 있어도 휴식 타이머 알림을 받아요.',
  ...
  'Your server': '내 서버',
  'Synced with your Halal Pro Gym server.': 'Halal Pro Gym 서버와 동기화됨',
  'Disconnect': '연결 해제',
  ...
  'Sync this device to your own self-hosted Halal Pro Gym instead.': '대신 이 기기를 직접 호스팅하는 Halal Pro Gym 서버와 동기화합니다.',
  'Pair the mobile app': '모바일 앱 페어링',
  'Connect the Halal Pro Gym app on your phone to this account.': '휴대폰의 Halal Pro Gym 앱을 이 계정에 연결하세요.',
  'Could not generate a code': '코드를 생성하지 못했습니다',
  'On the Halal Pro Gym app, choose “Connect to my server”, then enter this address and the code below. It expires in 5 minutes.': 'Halal Pro Gym 앱에서 "내 서버에 연결"을 선택한 다음, 이 주소와 아래 코드를 입력하세요. 5분 후 만료됩니다.',
  'Enter your server address and the code': '서버 주소와 코드를 입력하세요',
  'Connected': '연결됨',
  'Could not connect': '연결하지 못했습니다',
  'Open Settings → “Pair the mobile app” on the Halal Pro Gym site you’re already signed into, then enter its address and the code shown there.': '이미 로그인된 Halal Pro Gym 사이트에서 설정 → "모바일 앱 페어링"을 열고, 주소와 거기에 표시된 코드를 입력하세요.',
  'Server address (e.g. gym.example.com)': '서버 주소 (예: gym.example.com)',
  'Pairing code': '페어링 코드',
  'Connecting…': '연결 중…',
  'Connect': '연결',
  'How do you want to use Halal Pro Gym?': 'Halal Pro Gym을 어떻게 사용하시겠어요?',
  'Use on this device': '이 기기에서 사용',
  'Local keeps everything on this phone. Connecting syncs to your own Halal Pro Gym server instead — you can switch later in Settings.': '로컬 모드는 모든 것을 이 휴대폰에 보관합니다. 연결하면 대신 자신의 Halal Pro Gym 서버와 동기화됩니다 — 나중에 설정에서 변경할 수 있습니다.',
