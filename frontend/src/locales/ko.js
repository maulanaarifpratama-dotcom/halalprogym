...
export default {
  ...
  'Signs this profile out on every device, including this one. You can sign in again anytime.':
    '이 프로필을 이 기기를 포함해 모든 기기에서 로그아웃합니다. 언제든 다시 로그인할 수 있어요.',
  ...
  'to install Halal Pro Gym as a full-screen app.': '하면 Halal Pro Gym을 전체 화면 앱으로 설치할 수 있어요.',
  ...
  'back': '등', 'cardio': '유산소', 'chest': '가슴', 'full body': '전신', 'lower arms': '전완',
  ...
  'Exercise name': '운동 이름',
  'name + body part, no demo photo': '이름 + 부위, 데모 사진 없음',
  ...
  'A small file a friend imports into their own Halal Pro Gym — routines only, none of your workouts or weigh-ins.': '친구가 자신의 Halal Pro Gym으로 가져올 수 있는 작은 파일 — 루틴만 포함되며 운동 기록이나 체중은 포함되지 않습니다.',
  ...
  'A sign-in link is on its way to {0}. Open it on this device — the link signs you in here.':
    '로그인 링킬를 {0}으로 보내고 있어요. 이 기기에서 여세요 — 링킬로 여기에 로그인됩니다.',
  'All data stays on this device': '모든 데이타는 이 기기에만 남습니다',
  'Blocked in your browser settings.': '보여지기 설정에서 막혀 있어요.',
  'Check your email': '이메일을 확인하세요',
  'Continue with Google': 'Google로 계속',
  'Could not send the link': '링킬를 보낼 수 없었어요',
  'Deletes your plan, workouts and body weight — on this device and in your account. This cannot be undone.':
    '계획, 운동 기록, 체중을 지웅니다 — 이 기기와 계정 모다. 되돌릴 수 없어요.',
  'Demo': '데모',
  'Enter a valid email address': '유효한 이메일 주소를 입력하세요',
  'No account sync is set up in this build — everything stays on this device.':
    '이 보에는 계정 동기화가 없어요 — 모든 것이 이 기기에 남습니다.',
  'No password. We send a link — opening it signs you in.': '비밀번호 없이. 링킬를 보내드려요 — 여면 로그인됩니다.',
  'Off — a beep still plays while the app is open.': '끔 — 앱이 열려 있으면 샐드는 그대로 나와요.',
  'On — shown when a rest finishes.': '쯤 — 휴식이 끝나면 알려집니다.',
  'Reset': '초기화',
  'Rest timer alert': '휴식 타이맨 알림',
  'Send the link': '링킬 보내기',
  'Sending…': '보내는 중…',
  'Sign in with email': '이메일로 로그인',
  'Signing in only syncs your data — your workouts stay yours.':
    '로그인은 데이타 동기화만 합니다 — 운동 기록은 그대로 당신의 것입니다.',
  'Source code': '소스 코드',
  ...
  'Add a food': '음식 추가',
  'After iftar': '이프타르 후',
  'Calories (kcal)': '칼로리(kcal)',
  'Carbs': '탄수화물',
  'Carbs (g)': '탄수화물(g)',
  'Daily target': '하루 목표',
  'Delete food': '음식 삭제',
  'Delete food?': '음식을 삭제할까요?',
  'Edit food': '음식 수정',
  'Enter a valid amount': '올바른 수량을 입력하세요',
  'Enter a valid calorie number': '올바른 칼로리 숫자를 입력하세요',
  'Fasting day': '단식일',
  'Fat': '지방',
  'Fat (g)': '지방(g)',
  'Food': '음식',
  'How many grams?': '몇 그램인가요?',
  'How many {0}?': '{0} 몇 개인가요?',
  'Leave a field empty to track it without a target.': '목표 없이 기록만 하려면 비워두세요.',
  'Log food': '음식 기록',
  'Log it': '기록',
  'Logged today': '오늘 기록함',
  'Name': '이름',
  'No foods yet. Add the things you eat often — you only enter them once.':
    '아직 음식이 없어요. 자주 먹는 것을 추가하세요 — 한 번만 입력하면 됩니다.',
  'Nothing logged today.': '오늘은 기록이 없어요.',
  'Other meals': '기타 식사',
  'Past entries stay in your log, but they will no longer count toward totals.':
    '지난 기록은 그대로 남지만 더 이상 합계에 포함되지 않아요.',
  'Protein': '단백질',
  'Protein (g)': '단백질(g)',
  'Serving, e.g. 1 plate': '1회 분량, 예: 한 접시',
  'Suhoor': '수후르',
  'Today\'s intake': '오늘 섭취량',
  ...
  'serving': '1회 분량',
  'servings': '회 분량',
  '{0} kcal today': '오늘 {0} kcal',
  '{0} left today': '오늘 {0} 남음',
  '{0} of {1} kcal': '{1} kcal 중 {0}',
  '{0} over your target': '목표보다 {0} 초과',
  // --- perkiraan gizi AI (kunci milik pengguna) ---
  'A free key from Google AI Studio is enough for everyday use.': 'Google AI Studio의 무료 키만으로도 일상적인 사용에는 충분합니다.',
  'AI': 'AI',
  'AI estimates': 'AI 추정',
  'API key': 'API 키',
  'Add your own API key in Settings first.': '먼저 설정에서 본인의 API 키를 넣어 주세요.',
  'Check before saving': '저장 전에 확인하세요',
  'Describe it again': '다시 설명하기',
  'Describe it the way you would say it out loud, including how much.': '말하듯이, 얼마나 먹었는지까지 적어 주세요.',
  'Describe what you ate first.': '먼저 무엇을 먹었는지 적어 주세요.',
  'Editing on — your numbers win.': '수정 켜짐 — 직접 넣은 숫자가 우선입니다.',
  'Endpoint (optional) — default api.openai.com': '엔드포인트(선택) — 기본값 api.openai.com',
  'Estimate with AI': 'AI로 추정하기',
  'Estimating…': '추정 중…',
  'Get a free key': '무료 키 받기',
  'Grams per serving': '1회 제공량(g)',
  'If you log this': '이걸 기록하면',
  ...
  'Not set up': '설정되지 않음',
  'Nutrition estimates': '영양 추정',
  'Nutrition per serving': '1회 제공량 영양',
  'Optional. With your own API key, the app can estimate calories and macros from a description like "nasi uduk satu porsi" — which is exactly what no free, commercially usable Indonesian food database gives us.': '선택 기능입니다. 본인의 API 키가 있으면 "nasi uduk satu porsi" 같은 설명만으로도 열량과 주요 영양소를 추정할 수 있습니다 — 무료로 상업적 이용까지 가능한 인도네시아 음식 데이터베이스가 하나도 주지 못하는 바로 그것입니다.',
  'Paste your API key first.': '먼저 API 키를 붙여 넣으세요.',
  'Requests go straight from this device to {0} with your key. Your quota, your bill — and we never see either.': '요청은 본인 키와 함께 이 기기에서 {0}(으)로 바로 갑니다. 본인의 사용량, 본인의 청구서 — 둘 다 우리는 보지 않습니다.',
  'Save and log it': '저장하고 기록하기',
  'Save to my foods only': '내 음식에만 저장',
  'Saved to your foods': '내 음식에 저장됨',
  'Sent to your own provider with your own key. We never see it.': '본인 키로 본인이 고른 제공업체에 전송됩니다. 우리는 보지 않습니다.',
  'Set it up in Settings': '설정에서 준비하기',
  'Some numbers were out of physical range and were capped.': '물리적으로 불가능한 값이 있어 상한으로 잘렸습니다.',
  'That did not work. You can still add the food by hand.': '되지 않았습니다. 음식은 여전히 직접 추가할 수 있습니다.',
  'The answer could not be read. Try describing the food differently.': '응답을 읽을 수 없었습니다. 음식을 다르게 설명해 보세요.',
  'The calories and the macros disagree — check them before saving.': '열량과 주요 영양소가 맞지 않습니다 — 저장 전에 확인하세요.',
  'The key is stored on this device only, unencrypted, and is never synced or sent to us. Anyone with access to this browser profile can read it.': '키는 이 기기에만 암호화 없이 저장되며, 동기화되거나 우리에게 전송되지 않습니다. 이 브라우저 프로필에 접근할 수 있는 사람은 누구나 읽을 수 있습니다.',
  'The provider rejected that API key. Check it in Settings.': '제공업체가 그 API 키를 거부했습니다. 설정에서 확인하세요.',
  'The provider took too long. Try again, or enter the numbers by hand.': '제공업체 응답이 너무 오래 걸렸습니다. 다시 시도하거나 숫자를 직접 입력하세요.',
  'These numbers are an estimate, not a measurement.': '이 숫자는 추정치이며 측정값이 아닙니다.',
  'This browser will not let the app store anything.': '이 브라우저는 앱이 아무것도 저장하지 못하게 합니다.',
