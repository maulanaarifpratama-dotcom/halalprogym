...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Halal Pro Gym locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de Halal Pro Gym’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'Rest-timer alerts, even if Halal Pro Gym is closed.': 'Halal Pro Gym kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'Your server': 'Sunucun',
  'Synced with your Halal Pro Gym server.': 'Halal Pro Gym sunucunla senkronize edildi.',
  ...
  'Sync this device to your own self-hosted Halal Pro Gym instead.': "Bu cihazı bunun yerine kendi self-hosted Halal Pro Gym'inle senkronize et.",
  'Pair the mobile app': 'Mobil uygulamayı eşleştir',
  'Connect the Halal Pro Gym app on your phone to this account.': 'Telefonundaki Halal Pro Gym uygulamasını bu hesaba bağla.',
  'Could not generate a code': 'Kod oluşturulamadı',
  'On the Halal Pro Gym app, choose “Connect to my server”, then enter this address and the code below. It expires in 5 minutes.': 'Halal Pro Gym uygulamasında “Sunucuma bağlan”ı seç, ardından bu adresi ve aşağıdaki kodu gir. 5 dakika içinde sona erer.',
  'Enter your server address and the code': 'Sunucu adresini ve kodu gir',
  'Connected': 'Bağlandı',
  'Could not connect': 'Bağlanılamadı',
  'Open Settings → “Pair the mobile app” on the Halal Pro Gym site you’re already signed into, then enter its address and the code shown there.': 'Zaten oturum açtığın Halal Pro Gym sitesinde Ayarlar → “Mobil uygulamayı eşleştir”i aç, ardından adresini ve orada gösterilen kodu gir.',
  'Server address (e.g. gym.example.com)': 'Sunucu adresi (ör. gym.example.com)',
  'Pairing code': 'Eşleştirme kodu',
  'Connecting…': 'Bağlanıyor…',
  'Connect': 'Bağlan',
  'How do you want to use Halal Pro Gym?': "Halal Pro Gym'i nasıl kullanmak istersin?",
  'Use on this device': 'Bu cihazda kullan',
  'Local keeps everything on this phone. Connecting syncs to your own Halal Pro Gym server instead — you can switch later in Settings.': "Yerel, her şeyi bu telefonda tutar. Bağlanmak ise bunun yerine kendi Halal Pro Gym sunucunla senkronize eder — bunu daha sonra Ayarlar'dan değiştirebilirsin.",
