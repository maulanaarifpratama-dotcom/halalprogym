...
export default {
  ...
  'Signs this profile out on every device, including this one. You can sign in again anytime.':
    'Bu profilin oturumunu bu cihaz dahil tüm cihazlarda kapatır. Dilediğin zaman tekrar giriş yapabilirsin.',
  ...
  'to install Halal Pro Gym as a full-screen app.': 'ile Halal Pro Gym’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'back': 'sırt', 'cardio': 'kardiyo', 'chest': 'göğüs', 'full body': 'tüm vücut', 'lower arms': 'ön kollar',
  ...
  'name + body part, no demo photo': 'ad + vücut bölgesi, demo fotoğrafı yok',
  ...
  'A small file a friend imports into their own Halal Pro Gym — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi Halal Pro Gym\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
  ...
  '{0} equipment type': '{0} ekipman türü',
  ...
  'Prayer city': 'namaz vakitleri için şehir',
  'Imsak': 'İmsak',
  'tomorrow': 'yarın',
  '{0} now': 'şimdi {0}',
  ...
  'A sign-in link is on its way to {0}. Open it on this device — the link signs you in here.':
    'Giriş bağlantısı {0} adresine gidiyor. Bu cihazda aç — bağlantı seni burada oturum açtırır.',
  'All data stays on this device': 'Tüm veriler bu cihazda kalır',
  'Blocked in your browser settings.': 'Tarayıcı ayarlarında engellenmiş.',
  'Check your email': 'E-postanı kontrol et',
  'Continue with Google': 'Google ile devam et',
  'Could not send the link': 'Bağlantı gönderilemedi',
  'Deletes your plan, workouts and body weight — on this device and in your account. This cannot be undone.':
    'Planını, antrenmanlarını ve vücut ağırlığını siler — bu cihazda ve hesabında. Geri alınamaz.',
  'Demo': 'Demo',
  ...
  'No account sync is set up in this build — everything stays on this device.':
    'Bu derlemede hesap senkronizasyonu kurulu değil — her şey bu cihazda kalır.',
  'No password. We send a link — opening it signs you in.':
    'Şifre yok. Bir bağlantı gönderiyoruz — açtığında oturum açılır.',
  'Off — a beep still plays while the app is open.':
    'Kapalı — uygulama açıkken bip sesi yine çalar.',
  'On — shown when a rest finishes.': 'Açık — bir dinlenme bittiğinde gösterilir.',
  'Reset': 'Sıfırla',
  'Rest timer alert': 'Dinlenme süresi uyarısı',
  ...
  'Signing in only syncs your data — your workouts stay yours.':
    'Giriş yapmak sadece verilerini senkronize eder — antrenmanların sana ait kalır.',
  'Source code': 'Kaynak kodu',
  'Syncs your plan and history across your devices.':
    'Planını ve geçmişini cihazların arasında senkronize eder.',
  ...
  'Add a food': 'Besin ekle',
  'After iftar': 'İftardan sonra',
  'Calories (kcal)': 'Kalori (kcal)',
  'Carbs': 'Karbonhidrat',
  'Carbs (g)': 'Karbonhidrat (g)',
  'Daily target': 'Günlük hedef',
  'Delete food': 'Besini sil',
  'Delete food?': 'Besin silinsin mi?',
  'Edit food': 'Besini düzenle',
  'Enter a valid amount': 'Geçerli bir miktar gir',
  'Enter a valid calorie number': 'Geçerli bir kalori sayısı gir',
  'Fasting day': 'Oruç günü',
  'Fat': 'Yağ',
  'Fat (g)': 'Yağ (g)',
  'Food': 'Beslenme',
  'How many grams?': 'Kaç gram?',
  'How many {0}?': 'Kaç {0}?',
  'Leave a field empty to track it without a target.': 'Hedefsiz takip etmek için alanı boş bırak.',
  'Log food': 'Besin kaydet',
  'Log it': 'Kaydet',
  'Logged today': 'Bugün kaydedilenler',
  'Name': 'İsim',
  'No foods yet. Add the things you eat often — you only enter them once.':
    'Henüz besin yok. Sık yediğin şeyleri ekle — sadece bir kez girersin.',
  'Nothing logged today.': 'Bugün henüz bir şey kaydedilmedi.',
  'Other meals': 'Diğer öğünler',
  'Past entries stay in your log, but they will no longer count toward totals.':
    'Geçmiş kayıtlar günlüğünde kalır ama artık toplamlara sayılmaz.',
  'Protein': 'Protein',
  'Protein (g)': 'Protein (g)',
  'Serving, e.g. 1 plate': 'Porsiyon, örn. 1 tabak',
  'Suhoor': 'Sahur',
  'Today\'s intake': 'Bugünkü alım',
  'Unknown food': 'Bilinmeyen besin',
  'Your foods': 'Besinlerin',
  'kcal': 'kcal',
  'over': 'fazla',
  ...
  'serving': 'porsiyon',
  'servings': 'porsiyon',
  '{0} kcal today': 'bugün {0} kcal',
  '{0} left today': 'bugün {0} kaldı',
  '{0} of {1} kcal': '{1} kcal’nin {0}’ı',
  '{0} over your target': 'hedefinin {0} üstünde',
  // --- perkiraan gizi AI (kunci milik pengguna) ---
  'A free key from Google AI Studio is enough for everyday use.': 'Günlük kullanım için Google AI Studio’dan alınan ücretsiz anahtar yeter.',
  'AI': 'YZ',
  'AI estimates': 'YZ tahminleri',
  'API key': 'API anahtarı',
  'Add your own API key in Settings first.': 'Önce Ayarlar’da kendi API anahtarını ekle.',
  'Check before saving': 'Kaydetmeden önce kontrol et',
  'Describe it again': 'Yeniden anlat',
  'Describe it the way you would say it out loud, including how much.': 'Sesli söyleyeceğin gibi, miktarıyla birlikte yaz.',
  'Describe what you ate first.': 'Önce ne yediğini yaz.',
  'Editing on — your numbers win.': 'Düzenleme açık — senin sayıların geçerli.',
  'Endpoint (optional) — default api.openai.com': 'Uç nokta (isteğe bağlı) — varsayılan api.openai.com',
  'Estimate with AI': 'YZ ile tahmin et',
  'Estimating…': 'Tahmin ediliyor…',
  'Get a free key': 'Ücretsiz anahtar al',
  'Grams per serving': 'Porsiyon başına gram',
  'If you log this': 'Bunu kaydedersen',
  ...
  'Nutrition estimates': 'Besin değeri tahmini',
  'Nutrition per serving': 'Porsiyon başına besin değeri',
  'Optional. With your own API key, the app can estimate calories and macros from a description like "nasi uduk satu porsi" — which is exactly what no free, commercially usable Indonesian food database gives us.': 'İsteğe bağlı. Kendi API anahtarınla uygulama, «nasi uduk satu porsi» gibi bir tarifden kalori ve makroları tahmin edebilir — ki ücretsiz ve ticari olarak kullanılabilir hiçbir Endonezya besin veritabanı bunu vermiyor.',
  'Paste your API key first.': 'Önce API anahtarını yapıştır.',
  'Requests go straight from this device to {0} with your key. Your quota, your bill — and we never see either.': 'İstekler bu cihazdan doğrudan {0} adresine, senin anahtarınla gider. Senin kotan, senin faturan — ve ikisini de hiç görmeyiz.',
  'Save and log it': 'Kaydet ve deftere yaz',
  'Save to my foods only': 'Sadece besinlerime kaydet',
  'Saved to your foods': 'Besinlerine kaydedildi',
  'Sent to your own provider with your own key. We never see it.': 'Kendi anahtarınla kendi sağlayıcına gönderilir. Biz hiç görmeyiz.',
  'Set it up in Settings': 'Ayarlar’da kur',
  'Some numbers were out of physical range and were capped.': 'Bazı sayılar fiziksel sınırların dışındaydı ve kırpıldı.',
  'That did not work. You can still add the food by hand.': 'Olmadı. Besini yine de elle ekleyebilirsin.',
  'The answer could not be read. Try describing the food differently.': 'Yanıt okunamadı. Besini başka türlü anlatmayı dene.',
  'The calories and the macros disagree — check them before saving.': 'Kalori ve makrolar birbirini tutmuyor — kaydetmeden önce kontrol et.',
  'The key is stored on this device only, unencrypted, and is never synced or sent to us. Anyone with access to this browser profile can read it.': 'Anahtar yalnızca bu cihazda, şifrelenmemiş olarak tutulur; hiçbir zaman eşitlenmez ya da bize gönderilmez. Bu tarayıcı profiline erişebilen herkes onu okuyabilir.',
  'The provider rejected that API key. Check it in Settings.': 'Sağlayıcı bu API anahtarını reddetti. Ayarlar’dan kontrol et.',
  'The provider took too long. Try again, or enter the numbers by hand.': 'Sağlayıcı çok uzun sürdü. Yeniden dene ya da sayıları elle gir.',
  'These numbers are an estimate, not a measurement.': 'Bu sayılar bir tahmin, ölçüm değil.',
  'This browser will not let the app store anything.': 'Bu tarayıcı uygulamanın hiçbir şey kaydetmesine izin vermiyor.',
  ...
  'Search {0} packaged products and {1} Indonesian staples.':
    '{0} paketli ürün ve {1} Endonezya temel besini arasında ara.',
}
