...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Halal Pro Gym locally on this device.": 'Этот браузер не поддерживает ключи доступа — но Halal Pro Gym можно использовать локально на этом устройстве.',
  ...
  'Rest-timer alerts, even if Halal Pro Gym is closed.': 'Оповещения таймера отдыха, даже если Halal Pro Gym закрыт.',
  ...
  'Synced with your Halal Pro Gym server.': 'Синхронизировано с вашим сервером Halal Pro Gym.',
  ...
  'Sync this device to your own self-hosted Halal Pro Gym instead.': 'Синхронизировать это устройство с вашим собственным self-hosted Halal Pro Gym.',
  'Pair the mobile app': 'Сопряжение мобильного приложения',
  'Connect the Halal Pro Gym app on your phone to this account.': 'Подключите приложение Halal Pro Gym на телефоне к этому аккаунту.',
  'Could not generate a code': 'Не удалось создать код',
  'On the Halal Pro Gym app, choose “Connect to my server”, then enter this address and the code below. It expires in 5 minutes.': 'В приложении Halal Pro Gym выберите «Подключиться к моему серверу», затем введите этот адрес и код ниже. Он действителен 5 минут.',
  'Enter your server address and the code': 'Введите адрес вашего сервера и код',
  'Connected': 'Подключено',
  'Could not connect': 'Не удалось подключиться',
  'Open Settings → “Pair the mobile app” on the Halal Pro Gym site you’re already signed into, then enter its address and the code shown there.': 'В Настройках → «Сопряжение мобильного приложения» на сайте Halal Pro Gym, где вы уже вошли, введите его адрес и показанный там код.',
  'Server address (e.g. gym.example.com)': 'Адрес сервера (например, gym.example.com)',
  'Pairing code': 'Код сопряжения',
  'Connecting…': 'Подключение…',
  'Connect': 'Подключить',
  'How do you want to use Halal Pro Gym?': 'Как вы хотите использовать Halal Pro Gym?',
  'Use on this device': 'Использовать на этом устройстве',
  'Local keeps everything on this phone. Connecting syncs to your own Halal Pro Gym server instead — you can switch later in Settings.': 'Локальный режим хранит всё на этом телефоне. Подключение вместо этого синхронизирует данные с вашим сервером Halal Pro Gym — вы сможете изменить это позже в Настройках.',
