...
const P = {
  ...
  // Amplop: badan + lipatan. Live area 3..21, sama seperti clipboard di atasnya.
  mail: <><rect x="3.4" y="5.6" width="17.2" height="12.8" rx="2.4" /><path d="m4.2 7.6 7.8 5.4 7.8-5.4" /></>,
