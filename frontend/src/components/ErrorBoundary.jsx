...
export default class ErrorBoundary extends Component {
  ...
  componentDidCatch(err) { console.error('Halal Pro Gym render error:', err) }
  ...
  render() {
    ...
    return (
      <div className="narrow">
        ...
        <Button variant="primary" icon="reset" onClick={() => location.reload()}>{t('Reload Halal Pro Gym')}</Button>
        {active && <>
          <div style={{ height: 8 }} />
